  ...
  return (
    <div>
      ...
      <LegalPageLayout
        ...
        description="Encuentra respuestas a las preguntas más comunes sobre nuestros servicios, procesos y cómo podemos ayudarte a hacer crecer tu marca de alimentos y bebidas."
